...
Build stage-2 contract sheets 10..42 into specs/ (order: next-smallest-first). DONE so far: render, handshake, token, historical, replay, http_parse, mac, listener, relay_store, noise, grant_ledger, dispatch (12/42).
